...
# If there are missing values, print the details
...
```{r}
# Extract the Gender column (assuming 'golub_data' is your dataset)
...
ggplot(golub_data, aes(x = Gender, y = .data[[first_gene_colname]])) +
  geom_jitter(width = 0.1, height = 0) +  # Add jitter to avoid overlapping points
  theme_cpunk() +
